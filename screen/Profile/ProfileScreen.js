              ...
              >
                 {
                  UserList.map((item, index) => (
                    <TouchableOpacity key={index} onPress={() => navigation.navigate(item.path)} style={{paddingHorizontal: 14, paddingVertical: 18, backgroundColor: "#FFFFFF", marginBottom: 16, borderRadius: 12}}>
                        <View style={{flexDirection: "row", alignItems: "center", gap: 15}}>
                            <View>{item.icon}</View>
                            <Text style={{color: "#292625", fontSize: 14, fontFamily: "Poppins-Medium", letterSpacing: 1}}>{item.title}</Text>
                        </View>
                      </TouchableOpacity>
                  ))
                 }
              ...
              <View style={{marginTop: 16, paddingHorizontal: 16}}>
                  <View style={{flexDirection: "row", justifyContent: "space-between", alignItems: "center"}}>
                    <TouchableOpacity style={{flexDirection: "row", alignItems: "center", gap: 10}}>
                        ...
                        <Text style={{color: "#EB4335", fontSize: 14,fontFamily: "Poppins-SemiBold"}}>Deconnexion</Text>
                    </TouchableOpacity>
                    <View>
                      <TouchableOpacity>
                          <Text style={{color: "#0282C8", fontSize: 14,fontFamily: "Poppins-Medium",letterSpacing: 1, textAlign: "center", textDecorationLine: "underline"}}>Conditions générales</Text>
                      </TouchableOpacity>
                      <TouchableOpacity>
                          <Text style={{color: "#0282C8", fontSize: 14,fontFamily: "Poppins-Medium",letterSpacing: 1,  textAlign: "center", textDecorationLine: "underline"}}>Mentions légales</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
              </View>
