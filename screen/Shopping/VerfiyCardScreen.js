...
const VerifyCardChckoutScreen = ({ navigation }) => {
           ...
           <View style={{flex: 1}}>
                ...
                <ScrollView horizontal style={{paddingLeft: 10}} showsHorizontalScrollIndicator={false}>
                        {
                            cardData.map((item, index) => (
                                    <View style={{position: "relative", marginRight: 22, height: hp(22)}} key={index}>
                                        ...
                                        <View style={{ position: "absolute", bottom: 31, left: 30}}>
                                            <Text style={{color: "#fff", fontSize: 14, fontFamily: 'Poppins-Medium'}}>{item.card}</Text>
                                        </View>
                                        <View style={{ position: "absolute", top: 58, right: 40}}>
                                        <Image source={MasterCard}/>
                                        </View>
                                        <View style={styles.checkStyle}>
                                           <FontAwesome5 name="check" size={19} color="#4CB32B"/>
                                        </View>
                                    </View>
                            ))
                        }
                ...
                <View style={{paddingHorizontal: 25, marginTop: 20}}>
                   ...
                   <View style={{marginTop: 20, flex: 1, justifyContent: "flex-end", alignItems: 'center', paddingBottom: 72}}>
                     <Button title="Payez maintenant" navigation={() => navigation.navigate('ColiScreen')}/>
                   </View>
                </View>
...
export default VerifyCardChckoutScreen