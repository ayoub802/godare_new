...
const Button = ({ title, navigation, width }) => {
  return (
    <TouchableOpacity onPress={navigation} style={{ paddingVertical: 8,width: width ,paddingHorizontal: 22,flexDirection: "row", alignItems: "center",justifyContent: "center", backgroundColor: "#4E8FDA", borderRadius: 25}}>
